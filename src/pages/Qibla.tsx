    ...
    <div className="min-h-screen pb-20 bg-background">
      <div className="islamic-gradient islamic-pattern p-5 pt-6 pb-8 rounded-b-3xl">
        <div className="max-w-lg mx-auto">
          <div className="flex items-center gap-3 text-primary-foreground">
            ...
            <h1 className="text-lg font-bold flex-1">Qibla Compass</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 flex flex-col items-center justify-center mt-12">
        ...
        <div className="mt-8 text-center space-y-2">
          <p className="text-lg font-semibold text-foreground">Qibla Direction</p>
          <p className="text-3xl font-bold text-primary">45° NE</p>
          <p className="text-sm text-muted-foreground">Distance to Kaaba: ~7,500 km</p>
          <p className="text-xs text-muted-foreground mt-4">
            Enable location services for accurate direction
          </p>
        </div>
      </div>
    </div>
